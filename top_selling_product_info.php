...
<?php
                                        $con=new mysqli('localhost','upchaaar_root','babloo@098765','upchaaar_meds');
                                        $query= $con->query("select * from products where id='$p_id' && flag='top_products'");
	...
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Top Selling Product Info</li>
			</ul>
		</div>
	</div>
<!-- //products-breadcrumb -->
...
<!-- top-selling -->
	<div class="top-brands">
		<div class="container">
			...
			<?php
                                        $con=new mysqli('localhost','upchaaar_root','babloo@098765','upchaaar_meds');
                                        $query= $con->query("select * from products where flag='top_products' order by id DESC LIMIT 20 ");
								...
								<figure>
									...
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											...
											<a href="top_selling_product_info.php?p_id=<?php echo $row3['id'];?>"><img title=" " alt=" " src="<?php echo $row3['image'];?>" /></a>		
											<p><?php echo $row3['name'];?></p>
											<h4>Rs.<?php echo $row3['offer_price'];?> <span>Rs.<?php echo $row3['price'];?></span></h4>
										</div>
