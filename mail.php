...
<html>
<head>
<title>Upchaaar.com: Indian Online Pharmacy | Buy Medicines Online, Fast Delivery | Contact Us</title>
<!-- for-mobile-apps -->
			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					<ul>
						...
						<li>address<span>Upchaaar.com</span></li>
					</ul>
					<ul>
						<li><i class="fa fa-envelope" aria-hidden="true"></i></li>
						<li>email<span><a href="mailto:info@example.com">info@Upchaaar.com</a></span></li>
					</ul>
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i></li>
						<li>call to us<span>(+91) 000 0000 000</span></li>
					</ul>
				</div>
