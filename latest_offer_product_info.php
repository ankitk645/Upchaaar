...
<?php
                                        $con=new mysqli('localhost','upchaaar_root','babloo@098765','upchaaar_meds');
                                        $query= $con->query("select * from products where id='$p_id' && flag='latest_products'");
	...
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Latest Offer Product Info</li>
			</ul>
		</div>
	</div>
<!-- //products-breadcrumb -->
			...
			<div class="agileinfo_single">
				...
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="w3agile_description">
						...
						<p><?php echo $row['desscription'];?></p>
					</div>
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4>Rs.<?php echo $row['offer_price'];?> <span>Rs.<?php echo $row['normal_price'];?></span></h4>
						</div>
...
<!-- top-offers -->
	<div class="top-brands">
		<div class="container">
			...
			<?php
                                        $con=new mysqli('localhost','upchaaar_root','babloo@098765','upchaaar_meds');
                                        $query= $con->query("select * from products where flag='latest_offers' order by id DESC LIMIT 20 ");
										...
										<div class="snipcart-details top_brand_home_details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="discount_amount" value="<?php echo $row2['offer_price'];?>" />
													<input type="hidden" name="currency_code" value="INR" />
													<input type="hidden" name="return" value=" " />
													<input type="hidden" name="cancel_return" value=" " />
													<input type="submit" name="submit" value="Add to cart" class="button" />
