...
<html>
<head>
<title>About Us | Upchaar.com: Indian Online Pharmacy | Buy Medicines Online, Fast Delivery</title>
<!-- for-mobile-apps -->
...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<?php
$con=new mysqli('localhost','root','','meds_base');
$query= $con->query("select * from about_us");
$row2 = $query->fetch_assoc();
?>
<!-- about -->
		<div class="privacy about">
			<h3>About Us</h3>
			<p class="animi"><?php echo $row2['description'];?></p>
			<div class="agile_about_grids">
				<div class="col-md-6 agile_about_grid_right">
					<img src="<?php echo $row2['image'];?>" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-6 agile_about_grid_left">
					<ol>
						<li><?php echo $row2['serivce_item_1'];?></li>
						<li><?php echo $row2['serivce_item_2'];?></li>
						<li><?php echo $row2['serivce_item_3'];?></li>
						<li><?php echo $row2['serivce_item_4'];?></li>
						<li><?php echo $row2['serivce_item_5'];?></li>
						<li><?php echo $row2['serivce_item_6'];?></li>
					</ol>
				</div>
				<div class="clearfix"> </div>
			</div>
...
<!-- team -->
	<div class="team">
		<div class="container">
			...
			<?php
                                        $con=new mysqli('localhost','root','','meds_base');
                                        $query= $con->query("select * from amazing_team order by id ASC LIMIT 4 ");
                                        while($row3 = $query->fetch_assoc())
										{
										
                                         ?>
				<div class="col-md-3 agileits_team_grid">
					<img src="<?php echo $row3['image'];?>" alt=" " class="img-responsive" />
					<h4><?php echo $row3['name'];?></h4>
					<p><?php echo $row3['post'];?></p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="<?php echo $row3['social_fb'];?>" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="<?php echo $row3['social_twt'];?>" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
						<li><a href="<?php echo $row3['social_ggl'];?>" class="google"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
					</ul>
				</div>
					...
					<div class="wmuSlider example1 animated wow slideInUp" data-wow-delay=".5s">
						<div class="wmuSliderWrapper">
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								...
								<?php
                                        $con=new mysqli('localhost','root','','meds_base');
                                        $query= $con->query("select * from testimonials order by id DESC LIMIT 2 ");
                                        while($row4 = $query->fetch_assoc())
										{
										
                                         ?>
									<div class="col-md-6 w3_testimonials_grid">
										<p><i class="fa fa-quote-right" aria-hidden="true"></i><?php echo $row4['description'];?></p>
										<h4><?php echo $row4['name'];?> <span>Customer</span></h4>
									</div>
										<?php } ?>
