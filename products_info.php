...
<?php
                                        $con=new mysqli('localhost','upchaaar_root','babloo@098765','upchaaar_meds');
                                        $query= $con->query("select * from products where id='$p_id' ");
		...
		<div class="w3l_banner_nav_right">
			...
			<?php
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="<?php echo $row2['image'];?>" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="w3agile_description">
						...
						<p><?php echo $row2['desscription'];?></p>
					</div>
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4>Rs.<?php echo $row2['offer_price'];?> <span>Rs.<?php echo $row2['normal_price'];?></span></h4>
						</div>
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="item_name" value="<?php echo $row2['name'];?>" />
													<input type="hidden" name="amount" value="<?php echo $row2['normal_price'];?>" />
													<input type="hidden" name="discount_amount" value="<?php echo $row2['discount'];?>" />
...
<div class="top-brands">
		<div class="container">
			<h3>More Medical Products</h3>
			<div class="agile_top_brands_grids">
			<?php
                                        $con=new mysqli('localhost','upchaaar_root','babloo@098765','upchaaar_meds');
                                        $query= $con->query("select * from products order by id DESC LIMIT 20 ");
								...
								<figure>
									...
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											...
											<a href="products_info.php?p_id=<?php echo $row4['id'];?>"><img title=" " alt=" " src="<?php echo $row4['image'];?>" /></a>		
											<p><?php echo $row4['name'];?></p>
											<h4>Rs.<?php echo $row4['offer_price'];?> <span>Rs.<?php echo $row4['normal_price'];?></span></h4>
										</div>
										<div class="snipcart-details top_brand_home_details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="amount" value="<?php echo $row4['normal_price'];?>" />
