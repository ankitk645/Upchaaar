		...
		<div style=" float:left; padding-left:10px; width:260px; margin-left:100px;">
            ...
            ?>
					...
					<div style="padding-top:10px; padding-bottom:10px; background-color:#e6ffee; font-family: Roboto, Arial, sans-serif;">
						...
						<div style="margin-left:2px; margin-top:2px; width:846px; font-family: Roboto, Arial, sans-serif; padding:20px; padding-left:80px; background-color:#ffffff; font-family: Roboto, Arial, sans-serif;">
						
							<table style="font-size:14px; border-collapse: separate; border-spacing:30px 15px;">
										<tr>
										<td>Name</td>
