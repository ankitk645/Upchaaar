...
<!-- banner -->
	...
	<div class="banner">
		...
		<div style=" float:left; padding-left:10px; width:260px; margin-left:100px;">
			
			<a href="account_info.php">
			<div style="padding: 4px 0px 0px 20px; height:40px; font-size: 22px; border-radius:2px; font-weight: 600; background: #FA1818; color: #fff;">
				My Profile
			</div>
			</a>
			<div style="padding-top:20px;">
			<a href='my_orders.php'>
				<div class="my_acc"> My Orders</div>
			</a>
		
			<a href='update_address.php'>
				<div class="my_acc"> Update Address</div>
			</a>
		
			<a href=''>
				<div class="my_acc"> Change Password</div>
			</a>
			</div>
		</div>
		
			<div style="width:850px; margin-left:20px; float:left; padding-bottom:20px">
					...
					<div style="padding-top:10px; padding-bottom:10px; background-color:#e6ffee; font-family: Roboto, Arial, sans-serif;">
						<div style="margin-left:2px; margin-top:2px; width:846px; font-family: Roboto, Arial, sans-serif; padding:10px; padding-left:80px; background-color:#ffffff; font-family: Roboto, Arial, sans-serif;">
							...
							<table style="font-size:14px; border-collapse: separate; border-spacing:40px 20px;">
										...
										<td><input style="width:280px; padding-left:10px; height:40px; border-radius:2px; border:1px solid grey;" type="password" name="old_password"></td>
										</tr>
										<tr>
										<td>New Password</td>
										<td><input style="width:280px; padding-left:10px; height:40px; border-radius:2px; border:1px solid grey;" type="password" name="new_pass1"></td>
										</tr>
										<tr>
										<td>Re-Enter New Password</td>
										<td><input style="width:280px; padding-left:10px; height:40px; border-radius:2px; border:1px solid grey;" type="password" name="new_pass2"></td>
										</tr>
										<tr>
										<td></td>
										<td><input class="update_button" type="submit" name="update" value="Update Password"></td>
										</tr>
							</table>
						</div>	
					</div>
