					...
					<div style="padding-top:10px; padding-bottom:10px; background-color:#e6ffee; font-family: Roboto, Arial, sans-serif;">
						<div style="margin-left:2px; margin-top:2px; width:846px; font-family: Roboto, Arial, sans-serif; padding:10px; padding-left:80px; background-color:#ffffff; font-family: Roboto, Arial, sans-serif;">
							...
							<table style="font-size:14px; border-collapse: separate; border-spacing:40px 20px;">
										...
										<tr>
										<td>Blood Group</td>
										<td><input style="width:280px; padding-left:10px; height:40px; border-radius:2px; border:1px solid grey;" type="text" name="blood_group" ></td>
										</tr>
										<tr>
										<td>Unit</td>
										<td><input style="width:280px; padding-left:10px; height:40px; border-radius:2px; border:1px solid grey;" type="text" name="unit" ></td>
										</tr>
										
										<tr>
										<td></td>
										<td><input class="place_button" style="" type="submit" value="Apply For Blood" name="Submit"></td>
										</tr>
							</table>
						</div>	
					</div>
